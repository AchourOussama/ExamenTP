 ...
 */
final class Version20220506153334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, inscription_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, prénom VARCHAR(100) NOT NULL, INDEX IDX_717E22E35DAC5993 (inscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
